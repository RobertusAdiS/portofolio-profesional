...
export const journey: LearningExperience[] = [
  {
    ...
    description: 'Merefleksikan filosofi esensi pendidikan dan penanaman nilai dalam proses pembelajaran.',
    learningPoints: ['Filosofi pendidikan', 'Pendidikan nilai', 'Landasan pemikiran pendidikan'],
    competency: ['Reflektif', 'Landasan pedagogis'],
    reflection: 'Pembelajaran menjadi lebih bermakna ketika pendidik memahami landasan dan esensi nilai dari pendidikan.'
  },
  {
    id: 's1-2',
    semester: 1,
  ...
  },
  {
    ...
    description: 'Observasi, asistensi, dan praktik mengajar dengan pendampingan langsung di lingkungan sekolah nyata.',
    learningPoints: ['Observasi sekolah', 'Asistensi mengajar', 'Praktik terbimbing'],
  ...
  },
  {
    ...
    description: 'Eksplorasi strategi, metode, dan media pembelajaran yang memfasilitasi kreativitas.',
    learningPoints: ['Media interaktif', 'Inovasi pembelajaran', 'Desain kreatif'],
