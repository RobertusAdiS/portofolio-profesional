...
export const evidence: Evidence[] = [
  {
    ...
    category: "Semester 1",
    description:
      "Bukti tugas, jurnal refleksi, atau artefak pembelajaran dari mata kuliah Filosofi Pendidikan dan Pendidikan Nilai.",
    type: "document",
    url: "https://drive.google.com/file/d/1e3QtnwrgUtU-8Gkb_MWs9as50TkhPnYs/view?usp=drive_link",
    status: "available",
  },
  {
    id: "ev-s1-2",
    ...
    category: "Semester 1",
    description:
      "Dokumen profiling peserta didik dan rencana intervensi pembelajaran yang sesuai dengan karakteristik mereka.",
    type: "document",
  ...
  },
  {
    ...
    category: "Semester 1",
    description:
      "Rancangan modul ajar beserta instrumen asesmen dasar sebagai bukti penerapan pembelajaran mendalam.",
    type: "document",
  ...
  },
  {
    ...
    category: "Semester 1",
    description:
      "Video dokumentasi dan laporan observasi atau praktik mengajar terbimbing selama PPL di semester 1.",
    type: "video",
  ...
  },
  {
    ...
    category: "Semester 1",
    description:
      "Jurnal refleksi diri mengenai perkembangan mindset dan cara merespons tantangan selama PPG.",
    type: "document",
  ...
  },
  {
    ...
    category: "Semester 1",
    description:
      "Media pembelajaran interaktif atau inovasi strategi pembelajaran yang dirancang di kelas elektif ini.",
    type: "document",
